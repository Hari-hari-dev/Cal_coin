(function (global, factory) {
    ...
    messageFormatString.split("").forEach((char, ii) => {
      ...
      switch (state[TYPE$1]) {
        case 0 /* EscapeSequence */:
          nextState = { [START_INDEX]: ii, [TYPE$1]: 1 /* Text */ };
          break;
        case 1 /* Text */:
          if (char === "\\") {
            nextState = { [START_INDEX]: ii, [TYPE$1]: 0 /* EscapeSequence */ };
          } else if (char === "$") {
            nextState = { [START_INDEX]: ii, [TYPE$1]: 2 /* Variable */ };
          }
          break;
        case 2 /* Variable */:
          if (char === "\\") {
  ...
  var getBaseXDecoder$1 = (alphabet4) => {
    return createDecoder({
      read(rawBytes, offset) {
        ...
        const tailChars = getBaseXFromBigInt$1(base10Number, alphabet4);
  ...
  var getBase16Decoder$1 = () => createDecoder({
    read(bytes, offset) {
  ...
  var getUtf8Encoder = () => {
    let textEncoder;
    return createEncoder({
      getSizeFromValue: (value) => (textEncoder ||= new o$1()).encode(value).length,
      write: (value, bytes, offset) => {
        const bytesToAdd = (textEncoder ||= new o$1()).encode(value);
        bytes.set(bytesToAdd, offset);
        return offset + bytesToAdd.length;
      }
    });
  ...
  var getUtf8Decoder = () => {
    ...
    return createDecoder({
      read(bytes, offset) {
        const value = (textDecoder ||= new e$1()).decode(bytes.slice(offset));
  ...
  // src/address.ts
  var memoizedBase58Encoder$1;
  var memoizedBase58Decoder$1;
  function getMemoizedBase58Encoder$1() {
    if (!memoizedBase58Encoder$1) memoizedBase58Encoder$1 = getBase58Encoder$1();
    return memoizedBase58Encoder$1;
  }
  function getMemoizedBase58Decoder$1() {
    if (!memoizedBase58Decoder$1) memoizedBase58Decoder$1 = getBase58Decoder$1();
    return memoizedBase58Decoder$1;
  }
  function isAddress(putativeAddress) {
    ...
    const base58Encoder = getMemoizedBase58Encoder$1();
    try {
  ...
  function getAddressEncoder() {
    return transformEncoder(
      fixEncoderSize(getMemoizedBase58Encoder$1(), 32),
      (putativeAddress) => address(putativeAddress)
    );
  }
  function getAddressDecoder() {
    return fixDecoderSize(getMemoizedBase58Decoder$1(), 32);
  }
  ...
  exports.assertValidBaseString = assertValidBaseString$1;
  ...
  exports.getBase16Decoder = getBase16Decoder$1;
  exports.getBase16Encoder = getBase16Encoder;
  exports.getBase58Codec = getBase58Codec;
  exports.getBase58Decoder = getBase58Decoder$1;
  exports.getBase58Encoder = getBase58Encoder$1;
  ...
  exports.getBaseXDecoder = getBaseXDecoder$1;
  exports.getBaseXEncoder = getBaseXEncoder$1;
